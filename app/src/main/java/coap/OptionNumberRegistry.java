...
public class OptionNumberRegistry {
     ...
     *         the default value as specified in draft-ietf-core-coap-05
     */
     ...
     * @return An option corresponding to the given option number containing
     *         the given IP as specified in draft-ietf-core-coap-05
     */
     ...
     * @return An option corresponding to the given option number containing
     *         the given UDP port as specified in draft-ietf-core-coap-05
     */
